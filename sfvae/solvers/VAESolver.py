...
@gin.configurable('VAESolver', blacklist=['mode', 'log_dir', 'ckpt_dir'])
class VAESolver(BaseSolver):
    ...
    def __init__(self, mode, log_dir, ckpt_dir, 
        ...
        super(VAESolver, self).__init__()
        self.model_name = 'VAE'
        self.log_dir = log_dir
        self.log_flag = log_flag
        self.ckpt_dir  = ckpt_dir + 'VAE/'
    ...
    def train(self):
        ...
        progress_template = 'VAE: [{}] vae_recon_loss:{:.3f}'
